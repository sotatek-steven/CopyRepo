# Dapp Template With Material Design, Web3 build on NextJS

This example shows how you can setup front-end with material design, web3 to support your Next.js application.

**Project** is an application that allows users to add their Projects' information (e.g., name, owner's name, diet, age, dislikes, likes, and photo). They can also delete it or edit it anytime.
...
In the case of MongoDB Atlas, it should be a string like this update :
